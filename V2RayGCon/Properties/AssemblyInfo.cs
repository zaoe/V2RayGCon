...
/*
 * 1.2.2.4 Add select all button in subscription tab of form option.
 * 1.2.2.3 Filter out invalid GUID while importing vmess sharelink.
 * 1.2.2.2 Try to fix issue #5.
 * 1.2.2.1 Fix vmess decode/encode bug.
 */
